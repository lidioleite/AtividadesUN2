...
public interface interfaceFilaDupla {
    ...
    NoFilaDuplaEncadeada addInicio(int valor);  //insere um valor no início  da fila     
    NoFilaDuplaEncadeada addFim(int valor);  //insere um valor no fim da fila     
    NoFilaDuplaEncadeada removeInicio();  //retira o nó do início da fila     
    NoFilaDuplaEncadeada removeFim();  //retira o nó do fim da fila  
